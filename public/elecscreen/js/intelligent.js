    ...
    data: {
        ...
        warnOption: {
            ...
            series: [{
                ...
                data: [{ name: '标题', value: [50, 50], symbolSize: 20}]
            }]
        },
        //台区用电量趋势分析
        useEleData: {},
        ...
        getuseEleData: function() {
            ...
            $.get("./json/intelligent/useEle.asp", function(result) {
                ...
                $.each(self.useEleData.year, function(index, item) {
                    ...
                    if ((index + 1) % 4 == 0) {
                        self.useEleOption.baseOption.timeline.data[index] = { value: item, symbol: 'diamond', fontSize: 10 }
                    } else {
                        self.useEleOption.baseOption.timeline.data[index] = { value: item, symbolSize: 10 }
                    }
                });
        ...
        getPowerQualityData: function() {
            ...
            $.get("./json/intelligent/powerQuality.asp", function(result) {
                ...
                $.each(self.powerQualityData.year, function(index, item) {
                    ...
                    if ((index + 1) % 4 == 0) {
                        self.powerQualityOption.baseOption.timeline.data[index] = { value: item, symbol: 'diamond', fontSize: 10 }
                    } else {
                        self.powerQualityOption.baseOption.timeline.data[index] = { value: item, fontSize: 10 }
                    }
                });
                // 基于准备好的dom，初始化echarts实例
