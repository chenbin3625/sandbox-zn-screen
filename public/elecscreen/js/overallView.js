var vm = new Vue({
    ...
    data: {
        ...
        districtNameArr: ['', '乐昌市', '南雄市', '始兴县', '翁源县', '新丰县', '武江区', '浈江区', '仁化县', '曲江区'],
        // 风电项目情况
        windPowerData: {},
        windPowerChart: '',
        windPowerOption: {
    ...
    methods: {
        ...
        getCusChartData: function() {
            ...
            $.get("./json/overallView/cuschart.asp", function(result) {
                ...
                self.cusChartOption.width = 0; // specify the width of the chart in pixels
                self.cusChartOption.height = 400; // specify the height of the chart in pixels
        ...
        addText: function(result) {
            ...
            } else if (result.districtList[0].name == '') {
                opt = {
                    map: map,
                    text: result.districtList[0].name,
